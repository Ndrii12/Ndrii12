...
$message = "";
$data_file = "data.json"; // File untuk menyimpan data JSON
$allowed_tokens = ["oly11", "oly22", "oly33"];
                    ...
                    <tbody>
                        <?php foreach ($data_array as $index => $data): ?>
                            <tr>
                                ...
                                <td><?php echo isset($data["post_date"])
                                  ? date(
                                    "Y-m-d H:i",
                                    strtotime($data["post_date"])
                                  )
                                  : ""; ?></td>
                                <td><?php echo isset($data["link_tujuan"])
                                  ? htmlspecialchars($data["link_tujuan"])
                                  : ""; ?></td>
                                <td>
